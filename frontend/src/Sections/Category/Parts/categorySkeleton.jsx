...
const CategorySkeleton = () => {
  return (
    <div className="category-skeleton flex gap-[20px] mt-[170px] ml-[50px]">
      ...
      <div>
        ...
        {Array.from({ length: 6 }).map((_, i) => (
          <div
            key={i}
            className="category-skeleton-categories px-3 flex justify-between items-center w-[15vw] h-[41px] rounded-lg mb-2 bg-gray-300 animate-pulse"
          >
      ...
      <div className="category-skeleton-products flex-1">
